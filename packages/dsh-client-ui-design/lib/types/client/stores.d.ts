...
export declare const DEFAULT_PREVIEW_URL = "http://localhost:3000";
/** Maximum entries retained in the preview URL history. */
export declare const URL_HISTORY_MAX = 10;
/** Default chat-column width (viewport percentage). */
export declare const CHAT_WIDTH_DEFAULT = 25;
/** Minimum chat-column width (viewport percentage). */
export declare const CHAT_WIDTH_MIN = 15;
/** Maximum chat-column width (viewport percentage). */
export declare const CHAT_WIDTH_MAX = 60;
/**
 ...
 */
export declare function createDesignStore(): EngineStoreHandle<DesignState, DesignActions>;
